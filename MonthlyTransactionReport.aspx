<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyTransactionReport.aspx.cs"
    Inherits="admin_MonthlyTransactionReport" %>
    ...
    <div class="container-fluid">
                        ...
                        <nav class="navbar navbar-inverse rev-marg " role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <ul class="nav navbar-nav navbar-right navbar-user top-menu">
                                    ...
                                    <li><a href="MonthlyTransactionReportM1.aspx" class="btn btn-sm btn-orange">Monthly
                                        Trans. M1 </a></li>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                Monthly Transaction Report Details</h4>
                        </div>
                        ...
                        <%--<div class="modal-body" id="popup2" style="width: 600px; height: 200px; overflow: auto; margin-left: 364px;">
        ...
        <div class="col-md-12">
            <div style="text-align: center">
                ...
                <asp:Button ID="ShowButton" runat="server" Text="Show" CssClass="btn btn-info" 
                ...
                <table id="example" class="cell-border" cellpadding="0"  cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <%--<th>
                                Delivery Speed Dhaka
                            </th>
                            <th>
                                Delivery Speed OutSide Dhaka
                            </th>--%>
                            <th>
                                Status
                            </th>
                            ...
                            <th>
                                Merchant<br />Given To<br />Courier<br />M1
                            </th>
                            <th>
                                Packaged<br />Wait For<br />Delivery<br />M2
                            </th>
                            <th>
                                Paid<br />Delivery<br />Courier<br />M2
                            </th>
                            <th>
                                UnPaid<br />Delivery<br />Courier<br />M2
                            </th>
                            <th>
                                Successfully<br />Processed
                            </th>
                            <th>
                                Not<br />Verify<br />Yet M1
                            </th>
                            <th>
                                Under<br />Verification<br />M1
                            </th>
                            <th>
                                Under<br />Verification<br />M2
                            </th>
                            <th>
                                Not Yet<br />Confirm<br />By<br />Merchant<br />M2
                            </th>
                            <th>
                                Merchant<br />Confirm<br />But Not<br />Yet<br />Deliverd<br />To AD<br />M2
                            </th>
                            <th>
                                Merchant<br />Refuse<br />M1
                            </th>
                            <th>
                                Merchant<br />Refuse<br />M2
                            </th>
                            <th>
                                Ajkerdeal<br />Refuse<br />(QC)
                            </th>
                            <th>
                                Pre-<br />Shipment<br />Rejected<br />By<br />Customer<br />M1
                            </th>
                            <th>
                                Pre-<br />Shipment<br />Rejected<br />By<br />Customer<br />M2
                            </th>
                            <th>Ready To<br />
                                    Pick<br />
                                    From<br />
                            ...
                            <th>
                                Post<br />Shipment<br />RTO<br />M1
                            </th>
                            <th>
                                Post<br />Shipment<br />RTO<br />M2
                            </th>
                            <th>
                                Sum
                            </th>
    ...
    <script type="text/javascript">
        function GetReportsDetails(Data) {
            ...
            $.ajax({
                ...
                url: window.location.origin + window.location.pathname + "/GetReportDetailsMain",
                ...
                success: function (data) {
                    ...
                    //document.getElementById('popup2').innerHTML = data.d;
                },
        ...
        <script type="text/javascript">
            function GetDeliverySpeed(CompanyId, District) {
                ...
                $.ajax({
                    ...
                    data: "{ \'CompanyId\': \'" + CompanyId + "\', \'Month\': \'" + Month + "\', \'Year\': \'" + Year + "\', \'District\': \'" + District + "\' }",
                    dataType: "json",
                    async: true,
                    cache: false,
                    success: function (data) {
